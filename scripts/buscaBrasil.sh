...
if [ `ps -ef | grep busca_UR | wc -l` -le "1" ]
  then
    ...
    #echo "Regiao Norte"
    #ruby busca_UR.rb $1 $2 -66 5.3 -59 3 1
    #ruby busca_UR.rb $1 $2 -52.5 5 -50 3 1
    #ruby busca_UR.rb $1 $2 -69 3 -50 2 1
    #ruby busca_UR.rb $1 $2 -67.5 2 -49 0 1
    #ruby busca_UR.rb $1 $2 -67.5 0 -43.5 -2 1
    #ruby busca_UR.rb $1 $2 -67.5 -2 -37.5 -4 1
    #ruby busca_UR.rb $1 $2 -73.5 -4 -34.5 -6 1
    #ruby busca_UR.rb $1 $2 -74 -6 -34.5 -8 1

    #ruby busca_UR.rb $1 $2 -75 -8 -43.5 -9 1
    #ruby busca_UR.rb $1 $2 -43.5 -8 -43.2 -8.7 1
    ...
    #echo "Sao Paulo"
    ruby busca_UR.rb $1 $2 -47.5 -23 -43.5 -24 0.5
    ruby busca_UR.rb $1 $2 -47.5 -24 -45.5 -25 0.5
